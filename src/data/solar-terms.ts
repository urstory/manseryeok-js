...
export const SOLAR_TERM_NAMES: Array<{
  ...
  { name: '추분', hanja: '秋分', longitude: 180, type: 'junggi', sajuMonth: 9 },   // 양력 10월 8일경
  { name: '한로', hanja: '寒露', longitude: 195, type: 'jeolgi', sajuMonth: 9 },   // 양력 10월 8일경
  { name: '상강', hanja: '霜降', longitude: 210, type: 'junggi', sajuMonth: 10 },  // 양력 10월 23일경

  // 겨울 (冬)
  { name: '입동', hanja: '立冬', longitude: 225, type: 'jeolgi', sajuMonth: 10 },  // 양력 11월 7일경
  { name: '소설', hanja: '小雪', longitude: 240, type: 'junggi', sajuMonth: 10 },  // 양력 11월 22일경
  { name: '대설', hanja: '大雪', longitude: 255, type: 'jeolgi', sajuMonth: 11 },  // 양력 12월 7일경
  { name: '동지', hanja: '冬至', longitude: 270, type: 'junggi', sajuMonth: 11 },  // 양력 12월 22일경
  { name: '소한', hanja: '小寒', longitude: 285, type: 'jeolgi', sajuMonth: 12 },  // 양력 1월 6일경
  { name: '대한', hanja: '大寒', longitude: 300, type: 'junggi', sajuMonth: 12 },  // 양력 1월 20일경
];
